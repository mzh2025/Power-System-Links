...
- [Popular Open Source Libraries](https://github.com/jinningwang/best-of-ps)
- [Machine Learning for OPF](https://energy.hosting.acm.org/wiki/index.php/ML_OPF_wiki) (ChenMH)
- [RPG Lab - Xingpeng Li](https://rpglab.github.io/resources/)

## Dataset
- [TAMU - Dataset](https://electricgrids.engr.tamu.edu/#)
- [ISU - Smart Meter Data](https://wzy.ece.iastate.edu/Testsystem.html)
- [Global Energy Forecasting Competition 2012 - Wind Forecasting](https://www.kaggle.com/competitions/GEF2012-wind-forecasting/data)
